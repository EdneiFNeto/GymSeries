...
import com.gymseries.utils.ListUtils

class TricepsAdapter(val context: Context, private var triceps: ArrayList<Triceps>) :
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            Toast.makeText(context, "ID ${tricep.id}", Toast.LENGTH_SHORT).show()
